...
echo -e "  pgAdmin   : http://localhost:5050  (admin@4k.com / admin — dev only)"
echo ""
info "Gestion de l'admin :"
echo -e "  (défaut)               → admin créé automatiquement si aucun utilisateur n'existe"
echo -e "  CNP_CREATE_ADMIN=1 ... → forcer la recréation (ex: reset mot de passe)"
echo -e "  CNP_CREATE_ADMIN=0 ... → ne pas toucher aux utilisateurs"
echo -e "  CNP_ADMIN_EMAIL=you@example.com CNP_ADMIN_PASSWORD=secret ./start.sh"
echo ""
