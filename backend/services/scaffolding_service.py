...
def build_chart_yaml(app_name: str) -> str:
    data = {
        "apiVersion": "v2",
        "name": app_name,
...
class ScaffoldingService:
    ...
    def _build_values_yaml(
        ...
        return build_values_yaml(app_name, namespace, params, gitlab_group_id, gitlab_group_path)
    ...
    def _build_chart_yaml(self, app_name: str, params: ScaffoldingParams) -> str:
        return build_chart_yaml(app_name)
