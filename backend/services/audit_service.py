...
class AuditService:
    ...
    async def log_action(self, user_id: int, action: str, resource_id: Optional[int] = None, cloud: Optional[CloudType] = None, ip_address: Optional[str] = None, app_id: Optional[int] = None):
        log = AuditLog(
            user_id=user_id,
            action=action,
